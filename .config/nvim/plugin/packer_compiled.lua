...
_G.packer_plugins = {
  ...
  ["live-server.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/live-server.nvim",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  ["refactoring.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/refactoring.nvim",
